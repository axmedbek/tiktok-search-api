...
class ProtoWriter:
    ...
    def writeVarint(self, vint):
        while vint > 0x7F:  # Используйте 0x7F вместо 0x80
            self.write0((vint & 0x7F) | 0x80)  # Устанавливаем самый старший бит
            vint >>= 7  # Сдвигаем вправо на 7 бит
